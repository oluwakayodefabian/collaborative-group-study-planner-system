...
<div class="content">
    ...
    <div class="container">
        <h4>Chatroom - {{ $studyGroup->name }}</h4>
...
<script>
    $(function() {
        ...
        subscribedChannel = window.Echo.channel(`group.${$studyGroup}`);
        subscribedChannel.listen("NewGroupMessageEvent", (event) => {
        ...
        $('#chat-form').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{ route('user.study-groups.chat.send', $studyGroup) }}",
                method: "POST",
                data: formData,
                processData: false,
                contentType: false,
